 ...
 */
final class Version20200610171458 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, webauthn_id VARCHAR(180) DEFAULT NULL, display_name VARCHAR(255) DEFAULT NULL, icon VARCHAR(255) DEFAULT NULL)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D64920DC206A ON user (webauthn_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D649F85E0677');
        $this->addSql('DROP INDEX UNIQ_8D93D64920DC206A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, roles, password FROM user');
        $this->addSql('DROP TABLE user');
